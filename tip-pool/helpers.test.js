// describe = grouping test, stay organized!!!


// it ('should ...', function() {
//    expect(targetFunction()).someMatcher();
// })
// https://jasmine.github.io/api/edge/matchers.html

// clean up functions! 
// https://jasmine.github.io/api/edge/global.html#afterEach
describe("Utilities test (with setup and tear-down)", function() {
    beforeEach(function () { //before all test 
